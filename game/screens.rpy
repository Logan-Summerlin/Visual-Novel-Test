## screens.rpy
## Screens and UI for the visual novel.
...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("\n")
            text _("A visual novel about memory, choice, and the echoes we leave behind.")
...
screen help():
    ...
    use game_menu(_("Help"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                textbutton _("Keyboard") action SetScreenVariable("page", "keyboard")
                textbutton _("Mouse") action SetScreenVariable("page", "mouse")
...
screen ending_gallery():
    ...
    use game_menu(_("Endings"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Track your progress toward the true ending.") style "ending_header_text"
                ...
                for ending_info in [
                    ...
                    frame:
                        ...
                        vbox:
                            ...
                            yalign 0.5
                            spacing 5
                            if getattr(persistent, eid, False):
                                text etheme xalign 0.5 size 22
                                text ename xalign 0.5 size 18 color "#ffffff"
                                text "Unlocked" xalign 0.5 size 16 color "#88ff88"
                            else:
                                text "???" xalign 0.5 size 30 color "#666666"
                                text "Locked" xalign 0.5 size 16 color "#666666"
            ...
            frame:
                ...
                vbox:
                    ...
                    if persistent.ending_scholar and persistent.ending_guardian and persistent.ending_liberator and persistent.ending_shadow:
                        if getattr(persistent, "ending_true", False):
                            text "{color=#ffd700}The True Ending{/color}" xalign 0.5 size 28
                            text "\"Echoes Reunited\"" xalign 0.5 size 20 color "#ffffff"
                            text "Unlocked" xalign 0.5 size 16 color "#88ff88"
                        else:
                            text "{color=#ffd700}The True Ending{/color}" xalign 0.5 size 28
                            text "Now Available - Start a New Game!" xalign 0.5 size 18 color "#ffd700"
                    else:
                        text "The True Ending" xalign 0.5 size 28 color "#444444"
                        $ count = sum([1 for x in [persistent.ending_scholar, persistent.ending_guardian, persistent.ending_liberator, persistent.ending_shadow] if x])
                        text "[count]/4 endings discovered" xalign 0.5 size 18 color "#666666"

style ending_header_text:
    xalign 0.5
    size 24
    color "#cccccc"
